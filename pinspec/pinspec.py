...
class Circle(Surface):
    ...
    __del__ = lambda self : None;
    def getX0(self): return _pinspec.Circle_getX0(self)
    def getY0(self): return _pinspec.Circle_getY0(self)
    def getRadius(self): return _pinspec.Circle_getRadius(self)
