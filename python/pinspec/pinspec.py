...
class Isotope(_object):
    ...
    def rescaleCrossSections(self, *args): return _pinspec.Isotope_rescaleCrossSections(self, *args)
    def rescaleXS(self, *args): return _pinspec.Isotope_rescaleXS(self, *args)
    ...
    def initializeThermalScattering(self, *args): return _pinspec.Isotope_initializeThermalScattering(self, *args)
...
class Tally(_object):
    ...
    def setTallyName(self, *args): return _pinspec.Tally_setTallyName(self, *args)
